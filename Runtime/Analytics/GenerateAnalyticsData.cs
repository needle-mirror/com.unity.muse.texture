...
namespace Unity.Muse.Texture.Analytics
{
    ...
    class GenerateAnalytic : IAnalytic
    {
        ...
        internal GenerateAnalytic(string prompt, string promptNegative, bool inpaintingUsed, int imagesGeneratedNr, bool referenceImageUsed, bool isVariation)
        {
            m_Prompt = prompt;
